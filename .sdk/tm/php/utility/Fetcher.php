...
// Openf1CarData SDK utility: fetcher

class Openf1CarDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Openf1CarDataSDK/1.0)';
    ...
    public static function call(Openf1CarDataContext $ctx, string $fullurl, array $fetchdef): array
    {
