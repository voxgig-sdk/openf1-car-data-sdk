...
// Openf1CarData SDK audit feature
...
class Openf1CarDataAuditFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _emit(Openf1CarDataContext $ctx, string $outcome): void
    {
