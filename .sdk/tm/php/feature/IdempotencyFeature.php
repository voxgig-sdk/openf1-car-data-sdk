...
// Openf1CarData SDK idempotency feature
...
class Openf1CarDataIdempotencyFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _mutating(Openf1CarDataContext $ctx): bool
    {
