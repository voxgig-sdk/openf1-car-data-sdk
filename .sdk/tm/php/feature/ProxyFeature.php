...
// Openf1CarData SDK proxy feature
...
class Openf1CarDataProxyFeature extends Openf1CarDataBaseFeature
{
    ...
    public function init(Openf1CarDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Openf1CarDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
