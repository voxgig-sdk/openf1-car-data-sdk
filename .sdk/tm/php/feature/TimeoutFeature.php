...
// Openf1CarData SDK timeout feature
...
class Openf1CarDataTimeoutFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _with_timeout(Openf1CarDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Openf1CarDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
