...
// Openf1CarData SDK cache feature
...
class Openf1CarDataCacheFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _through(Openf1CarDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
