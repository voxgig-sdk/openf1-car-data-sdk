...
from projectname_sdk.core.control import Openf1CarDataControl
...
class Openf1CarDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = Openf1CarDataControl()
        ...
        if isinstance(sp, Openf1CarDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, Openf1CarDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, Openf1CarDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Openf1CarDataError(code, msg, self)
