...
class Openf1CarDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Openf1CarDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = Openf1CarDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = Openf1CarDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
