...
class Openf1CarDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Openf1CarDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = Openf1CarDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = Openf1CarDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
