...
from projectname_sdk import Openf1CarDataSDK
from projectname_sdk.core.spec import Openf1CarDataSpec
from projectname_sdk.core.result import Openf1CarDataResult
from projectname_sdk.core.response import Openf1CarDataResponse
from projectname_sdk.core.operation import Openf1CarDataOperation
from projectname_sdk.core.error import Openf1CarDataError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import Openf1CarDataBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return Openf1CarDataError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except Openf1CarDataError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = Openf1CarDataResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = Openf1CarDataSDK.test(None, None)
        ...
        class TestInitFeature(Openf1CarDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(Openf1CarDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = Openf1CarDataSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = Openf1CarDataSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = Openf1CarDataSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = Openf1CarDataOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = Openf1CarDataSDK.test(None, setup_opts)
