...
|---|---|---|
| `ts/` | @voxgig-sdk/openf1-car-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/openf1-car-data-sdk \
      --repository voxgig-sdk/openf1-car-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/openf1-car-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/openf1-car-data-sdk --id=<id>` removes it.
