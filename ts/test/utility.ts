...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.OPENF1CARDATA_TEST_LIVE ||
    'TRUE' === process.env.OPENF1CARDATA_TEST_OVERRIDE
  ) {
  ...
  m.OPENF1CARDATA_TEST_EXPLAIN = process.env.OPENF1CARDATA_TEST_EXPLAIN || m.OPENF1CARDATA_TEST_EXPLAIN
