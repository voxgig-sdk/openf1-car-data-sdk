...
(0, node_test_1.describe)('EndpointPathPostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-endpoint_path_post', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-endpoint_path_post', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENF1_CAR_DATA_TEST_ENDPOINT_PATH_POST_ENTID'];
...
//# sourceMappingURL=EndpointPathPostDirect.test.js.map