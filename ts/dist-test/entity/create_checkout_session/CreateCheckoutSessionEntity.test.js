...
(0, node_test_1.describe)('CreateCheckoutSessionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'create_checkout_session.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != create_checkout_session_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/create_checkout_session/CreateCheckoutSessionTestData.json');
    ...
    let idmap = transform(['create_checkout_session01', 'create_checkout_session02', 'create_checkout_session03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CreateCheckoutSessionEntity.test.js.map