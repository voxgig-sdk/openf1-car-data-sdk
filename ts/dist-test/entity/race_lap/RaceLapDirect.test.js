...
(0, node_test_1.describe)('RaceLapDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-race_lap', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-race_lap', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENF1_CAR_DATA_TEST_RACE_LAP_ENTID'];
...
//# sourceMappingURL=RaceLapDirect.test.js.map