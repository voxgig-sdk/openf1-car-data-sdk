...
(0, node_test_1.describe)('SubscriptionSuccessEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscription_success.' + op, live))
                return;
        }
        ...
        let subscription_success_ref01_data = Object.values(setup.data.existing.subscription_success)[0];
        // LOAD
        const subscription_success_ref01_ent = client.SubscriptionSuccess();
        const subscription_success_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != subscription_success_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscription_success/SubscriptionSuccessTestData.json');
    ...
    let idmap = transform(['subscription_success01', 'subscription_success02', 'subscription_success03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['OPENF1_CAR_DATA_TEST_SUBSCRIPTION_SUCCESS_ENTID'];
...
//# sourceMappingURL=SubscriptionSuccessEntity.test.js.map