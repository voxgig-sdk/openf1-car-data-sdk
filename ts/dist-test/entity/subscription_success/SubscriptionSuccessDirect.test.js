...
(0, node_test_1.describe)('SubscriptionSuccessDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.Openf1CarDataSDK({
    ...
    (0, node_test_1.test)('direct-load-subscription_success', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscription_success', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OPENF1_CAR_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.Openf1CarDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['OPENF1_CAR_DATA_TEST_SUBSCRIPTION_SUCCESS_ENTID'];
    ...
    const client = new __1.Openf1CarDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SubscriptionSuccessDirect.test.js.map