...
(0, node_test_1.describe)('SubscriptionCancelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-subscription_cancel', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscription_cancel', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENF1_CAR_DATA_TEST_SUBSCRIPTION_CANCEL_ENTID'];
...
//# sourceMappingURL=SubscriptionCancelDirect.test.js.map