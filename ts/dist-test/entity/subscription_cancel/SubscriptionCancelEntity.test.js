...
(0, node_test_1.describe)('SubscriptionCancelEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.SubscriptionCancel();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.OPENF1_CAR_DATA_TEST_LIVE;
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscription_cancel.' + op, live))
                return;
        }
        ...
        let subscription_cancel_ref01_data = Object.values(setup.data.existing.subscription_cancel)[0];
        // LOAD
        const subscription_cancel_ref01_ent = client.SubscriptionCancel();
        const subscription_cancel_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != subscription_cancel_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscription_cancel/SubscriptionCancelTestData.json');
    ...
    let idmap = transform(['subscription_cancel01', 'subscription_cancel02', 'subscription_cancel03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['OPENF1_CAR_DATA_TEST_SUBSCRIPTION_CANCEL_ENTID'];
...
//# sourceMappingURL=SubscriptionCancelEntity.test.js.map