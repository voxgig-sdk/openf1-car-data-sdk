...
function envOverride(m) {
    if ('TRUE' === process.env.OPENF1_CAR_DATA_TEST_LIVE ||
        'TRUE' === process.env.OPENF1_CAR_DATA_TEST_OVERRIDE) {
    ...
    m.OPENF1_CAR_DATA_TEST_EXPLAIN = process.env.OPENF1_CAR_DATA_TEST_EXPLAIN || m.OPENF1_CAR_DATA_TEST_EXPLAIN;
    return m;
}
