...
class Openf1CarDataSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('Openf1CarDataSDK: graphql: ' +
  ...
  CreateCheckoutSession(entopts?: Record<string, any>) {
    const self = this
    return new CreateCheckoutSessionEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EndpointPathPost(entopts?: Record<string, any>) {
    const self = this
    return new EndpointPathPostEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  RaceLap(entopts?: Record<string, any>) {
    const self = this
    return new RaceLapEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SubscriptionCancel(entopts?: Record<string, any>) {
    const self = this
    return new SubscriptionCancelEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SubscriptionSuccess(entopts?: Record<string, any>) {
    const self = this
    return new SubscriptionSuccessEntity(self, entopts)
  }
