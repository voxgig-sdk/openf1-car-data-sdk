...
func registerSDKWords(r *eng.Registry, client *sdk.Openf1CarDataSDK) {
...
func runOp(client *sdk.Openf1CarDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
