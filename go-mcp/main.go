// Command Openf1CarData-mcp is an MCP server exposing the Openf1CarData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Openf1CarData_list  — list records of an entity
//	Openf1CarData_load  — load a single record of an entity
//
