...
// Openf1CarData SDK pipeline test
//
...
{
    private static function utility(): Openf1CarDataUtility
    {
        return new Openf1CarDataUtility();
    }
    ...
    private static function ctx(array $over = []): Openf1CarDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Openf1CarDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Openf1CarDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Openf1CarDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Openf1CarDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Openf1CarDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Openf1CarDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Openf1CarDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Openf1CarDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Openf1CarDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Openf1CarDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Openf1CarDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Openf1CarDataResponse([]),
            'result' => new Openf1CarDataResult([]),
        ]);
        [, $err] = Openf1CarDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Openf1CarDataSpec([]),
            'response' => null,
            'result' => new Openf1CarDataResult([]),
        ]);
        [, $err] = Openf1CarDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Openf1CarDataSpec(['step' => 's']),
            'response' => new Openf1CarDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Openf1CarDataResult([]),
        ]);
        [, $err] = Openf1CarDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Openf1CarDataSpec(['step' => 's']),
            'response' => new Openf1CarDataResponse(self::resp(200, ['v' => 1])),
            'result' => new Openf1CarDataResult([]),
        ]);
        [, $err] = Openf1CarDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Openf1CarDataSpec(['step' => 's']),
            'response' => new Openf1CarDataResponse(self::resp(200, ['v' => 2])),
            'result' => new Openf1CarDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Openf1CarDataMakeResponse::call($ctx);
    ...
    {
        $preset = new Openf1CarDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Openf1CarDataSpec([]),
            'response' => new Openf1CarDataResponse([]),
            'result' => new Openf1CarDataResult([]),
        ...
        [$got, $err] = Openf1CarDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Openf1CarDataResult([])]);
        [, $err] = Openf1CarDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Openf1CarDataSpec([]), 'result' => null]);
        [, $err] = Openf1CarDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Openf1CarDataSpec(['step' => 's']),
            'result' => new Openf1CarDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Openf1CarDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Openf1CarDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Openf1CarDataSpec(['step' => 's']),
            'result' => new Openf1CarDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Openf1CarDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Openf1CarDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Openf1CarDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Openf1CarDataSpec([]),
            'result' => new Openf1CarDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Openf1CarDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Openf1CarDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Openf1CarDataError('boom', 'boom');
        $utility->fetcher = function (Openf1CarDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Openf1CarDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Openf1CarDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Openf1CarDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Openf1CarDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Openf1CarDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        Openf1CarDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Openf1CarDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Openf1CarDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Openf1CarDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Openf1CarDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Openf1CarDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Openf1CarDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Openf1CarDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Openf1CarDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Openf1CarDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Openf1CarDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Openf1CarDataResult(['ok' => false])]);
        $this->expectException(Openf1CarDataError::class);
        Openf1CarDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Openf1CarDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Openf1CarDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Openf1CarDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Openf1CarDataBaseFeature();
        $b = new Openf1CarDataBaseFeature();
        Openf1CarDataFeatureAdd::call($ctx, $a);
        Openf1CarDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Openf1CarDataBaseFeature
    {
        $f = new Openf1CarDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Openf1CarDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Openf1CarDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Openf1CarDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Openf1CarDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        Openf1CarDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Openf1CarDataResponse(['headers' => null]),
            'result' => new Openf1CarDataResult([]),
        ]);
        Openf1CarDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        Openf1CarDataResultBody::call($ctx);
