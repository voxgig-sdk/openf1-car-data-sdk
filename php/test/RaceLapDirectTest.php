...
class RaceLapDirectTest extends TestCase
{
    public function test_direct_load_race_lap(): void
    {
        $setup = race_lap_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-race_lap", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
