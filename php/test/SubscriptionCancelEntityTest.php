...
class SubscriptionCancelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENF_CARDATA_TEST_SUBSCRIPTION_CANCEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function subscription_cancel_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENF_CARDATA_TEST_SUBSCRIPTION_CANCEL_ENTID");
