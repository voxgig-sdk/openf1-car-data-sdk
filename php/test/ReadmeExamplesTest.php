...
// Openf1CarData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Openf1CarDataSDK::test)
...
{
    private const SDK_CLASS = 'Openf1CarDataSDK';
    ...
    private const SDK_BASE = 'openf1cardata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openf1cardata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
