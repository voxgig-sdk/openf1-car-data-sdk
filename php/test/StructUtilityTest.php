...
// Openf1CarData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = Openf1CarDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(Openf1CarDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(Openf1CarDataOmni::structfix($val, Struct::undef()))) {
