...
class RaceLapEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENF_CARDATA_TEST_RACE_LAP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function race_lap_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENF_CARDATA_TEST_RACE_LAP_ENTID");
