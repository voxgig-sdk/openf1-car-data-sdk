...
// Openf1CarData SDK utility type

class Openf1CarDataUtility
{
    ...
    public static function copy(Openf1CarDataUtility $src): Openf1CarDataUtility
    {
        $u = new Openf1CarDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
