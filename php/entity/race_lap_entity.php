...
// Openf1CarData SDK RaceLap entity
...
class RaceLapEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RaceLapEntity($this->_client, $opts);
    }

    /**
     * @param RaceLap|array $args RaceLap data (assoc-array) to store.
     */
    ...
    /**
     * @return RaceLap|array The current RaceLap data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RaceLap fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RaceLap fields).
     */
    ...
    /**
     * Load a single RaceLap.
     *
     * @param RaceLapLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RaceLapLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RaceLap|array The loaded RaceLap as an assoc-array at the
    ...
    /**
     * Create a new RaceLap.
     *
     * @param RaceLapCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RaceLapCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RaceLap|array The created RaceLap as an assoc-array at the
     *   SDK boundary; throws Openf1CarDataError on failure (item-5 convention).
     */
