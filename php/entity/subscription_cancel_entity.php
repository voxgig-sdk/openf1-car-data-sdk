...
class SubscriptionCancelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscription_cancel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionCancelEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionCancel|array $args SubscriptionCancel data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionCancel|array The current SubscriptionCancel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionCancel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionCancel fields).
     */
     ...
     *
     * @param SubscriptionCancelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SubscriptionCancelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionCancel|array The loaded SubscriptionCancel as an assoc-array at the
