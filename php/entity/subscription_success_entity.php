...
// Openf1CarData SDK SubscriptionSuccess entity
...
class SubscriptionSuccessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscription_success";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionSuccessEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionSuccess|array $args SubscriptionSuccess data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionSuccess|array The current SubscriptionSuccess data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionSuccess fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionSuccess fields).
     */
    ...
    /**
     * Load a single SubscriptionSuccess.
     *
     * @param SubscriptionSuccessLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SubscriptionSuccessLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionSuccess|array The loaded SubscriptionSuccess as an assoc-array at the
