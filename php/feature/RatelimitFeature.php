...
// Openf1CarData SDK ratelimit feature
...
class Openf1CarDataRatelimitFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _acquire(Openf1CarDataContext $ctx): void
    {
    ...
    private function _track(Openf1CarDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
