...
// Openf1CarData SDK metrics feature
...
class Openf1CarDataMetricsFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _record(Openf1CarDataContext $ctx, bool $ok): void
    {
