...
// Openf1CarData SDK rbac feature
...
class Openf1CarDataRbacFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _required(Openf1CarDataContext $ctx): ?string
    {
    ...
    private function _reject(Openf1CarDataContext $ctx, string $required): void
    {
    ...
    private function _track(Openf1CarDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
