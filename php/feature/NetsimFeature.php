...
// Openf1CarData SDK netsim feature
...
class Openf1CarDataNetsimFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _simulate(Openf1CarDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Openf1CarDataContext $ctx, array $applied): void
    {
        $client = $this->client;
