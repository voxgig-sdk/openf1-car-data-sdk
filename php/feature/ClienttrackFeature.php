...
// Openf1CarData SDK clienttrack feature
...
class Openf1CarDataClienttrackFeature extends Openf1CarDataBaseFeature
{
    ...
    public function PostConstruct(Openf1CarDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Openf1CarData-SDK';
