...
// Openf1CarData SDK telemetry feature
...
class Openf1CarDataTelemetryFeature extends Openf1CarDataBaseFeature
{
    ...
    private function _close(Openf1CarDataContext $ctx, bool $ok): void
    {
