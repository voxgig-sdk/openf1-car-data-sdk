...
// Openf1CarData SDK utility: make_options

class Openf1CarDataMakeOptions
{
    ...
    public static function call(Openf1CarDataContext $ctx): array
    {
        ...
        //
        // `Openf1CarDataSchema::optspec()` is built from the model:
        ...
        $optspec = Openf1CarDataSchema::optspec();
