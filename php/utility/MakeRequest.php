...
// Openf1CarData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Openf1CarDataMakeRequest
{
    public static function call(Openf1CarDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Openf1CarDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Openf1CarDataResponse($fetched);
        } else {
