...
// Openf1CarData SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Openf1CarDataParam
{
    public static function call(Openf1CarDataContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Openf1CarDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
