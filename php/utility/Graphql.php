...
// Openf1CarData SDK utility: graphql
//
...
class Openf1CarDataGraphql
{
    ...
    // equivalent.
    public static function body(Openf1CarDataContext $ctx): mixed
    {
    ...
    public static function errors(Openf1CarDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
