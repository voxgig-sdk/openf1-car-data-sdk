...
The Python SDK for the Openf1CarData API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.CreateCheckoutSession(None).create({"name": "Example"}, None)
...
result, err = client.Openf1CarData(None).load(
    {"id": "test01"}, None
)
