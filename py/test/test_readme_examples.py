# Openf1CarData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Openf1CarDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Openf1CarDataSDK(...) and Openf1CarDataSDK.test(...) become
#      Openf1CarDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openf1cardata_sdk"
_SDK_CLASS = "Openf1CarDataSDK"
...
_ENTITIES = {
    ...
    "EndpointPathPost": "endpoint_path_post",
    "RaceLap": "race_lap",
