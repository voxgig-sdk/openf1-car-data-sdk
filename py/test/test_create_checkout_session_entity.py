    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set OPENF_CARDATA_TEST_CREATE_CHECKOUT_SESSION_ENTID JSON to run live")
        client = setup["client"]
...
def _create_checkout_session_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "OPENF_CARDATA_TEST_CREATE_CHECKOUT_SESSION_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("OPENF_CARDATA_TEST_CREATE_CHECKOUT_SESSION_ENTID"))
