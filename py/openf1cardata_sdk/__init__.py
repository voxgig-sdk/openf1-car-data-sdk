...
from openf1cardata_sdk.utility import register

# Load features
from openf1cardata_sdk.feature.base_feature import Openf1CarDataBaseFeature
from openf1cardata_sdk.features import _has_feature, _make_feature
...
class Openf1CarDataSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "Openf1CarDataSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Openf1CarDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CreateCheckoutSession(self, data=None) -> "CreateCheckoutSessionEntity":
        ...
        from openf1cardata_sdk.entity.create_checkout_session_entity import CreateCheckoutSessionEntity
    ...
    def EndpointPathPost(self, data=None) -> "EndpointPathPostEntity":
        ...
        from openf1cardata_sdk.entity.endpoint_path_post_entity import EndpointPathPostEntity
    ...
    def RaceLap(self, data=None) -> "RaceLapEntity":
        ...
        from openf1cardata_sdk.entity.race_lap_entity import RaceLapEntity
    ...
    def SubscriptionCancel(self, data=None) -> "SubscriptionCancelEntity":
        ...
        from openf1cardata_sdk.entity.subscription_cancel_entity import SubscriptionCancelEntity
    ...
    def SubscriptionSuccess(self, data=None) -> "SubscriptionSuccessEntity":
        ...
        from openf1cardata_sdk.entity.subscription_success_entity import SubscriptionSuccessEntity
    ...
    def Token(self, data=None) -> "TokenEntity":
        ...
        from openf1cardata_sdk.entity.token_entity import TokenEntity
    ...
    def Webhook(self, data=None) -> "WebhookEntity":
        ...
        from openf1cardata_sdk.entity.webhook_entity import WebhookEntity
