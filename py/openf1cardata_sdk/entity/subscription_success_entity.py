...
from openf1cardata_sdk.openf1cardata_types import (
    SubscriptionSuccess,
    SubscriptionSuccessLoadMatch,
)
...
class SubscriptionSuccessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionSuccessEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionSuccess:
    ...
    def match_get(self) -> SubscriptionSuccess:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SubscriptionSuccess:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SubscriptionSuccess().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
