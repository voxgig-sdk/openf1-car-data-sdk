...
class SubscriptionCancelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionCancelEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionCancel:
    ...
    def match_get(self) -> SubscriptionCancel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SubscriptionCancel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SubscriptionCancel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
