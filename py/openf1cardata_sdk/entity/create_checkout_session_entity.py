...
class CreateCheckoutSessionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateCheckoutSessionEntity(self._client, opts)
    ...
    def data_get(self) -> CreateCheckoutSession:
    ...
    def match_get(self) -> CreateCheckoutSession:
    ...
    def create(self, reqdata: CreateCheckoutSessionCreateData, ctrl=None) -> CreateCheckoutSession:
        utility = self._utility
