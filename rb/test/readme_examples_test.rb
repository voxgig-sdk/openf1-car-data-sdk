...
#      offline in seeded test mode (Openf1CarDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Openf1CarData_sdk.rb")
  SDK_CLASS = "Openf1CarDataSDK"
