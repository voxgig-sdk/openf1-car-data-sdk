...
class EndpointPathPostEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OPENF_CARDATA_TEST_ENDPOINT_PATH_POST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def endpoint_path_post_basic_setup(extra)
  ...
  entid_env_raw = ENV["OPENF_CARDATA_TEST_ENDPOINT_PATH_POST_ENTID"]
