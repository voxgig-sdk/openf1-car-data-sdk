...
describe("EndpointPathPostDirect", function()
  it("should direct-load-endpoint_path_post", function()
    local setup = endpoint_path_post_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-endpoint_path_post", setup.live and "live" or "unit")
...
function endpoint_path_post_direct_setup(mockres)
