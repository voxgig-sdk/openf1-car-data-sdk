...
local SDK_MODULE = "openf1-car-data_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["create_checkout_session"] = { ["test01"] = { id = "test01" } }, ["endpoint_path_post"] = { ["test01"] = { id = "test01" } }, ["race_lap"] = { ["test01"] = { id = "test01" } }, ["subscription_cancel"] = { ["test01"] = { id = "test01" } }, ["subscription_success"] = { ["test01"] = { id = "test01" } }, ["token"] = { ["test01"] = { id = "test01" } }, ["webhook"] = { ["test01"] = { id = "test01" } } } }'
