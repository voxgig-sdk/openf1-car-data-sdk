...
function runner.env_override(m)
  local live = runner.getenv("OPENF1CARDATA_TEST_LIVE")
  local override = runner.getenv("OPENF1CARDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENF1CARDATA_TEST_EXPLAIN")
