-- SubscriptionSuccess direct test
...
describe("SubscriptionSuccessDirect", function()
  it("should direct-load-subscription_success", function()
    local setup = subscription_success_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-subscription_success", setup.live and "live" or "unit")
...
function subscription_success_direct_setup(mockres)
