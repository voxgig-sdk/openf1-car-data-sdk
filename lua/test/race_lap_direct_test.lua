...
describe("RaceLapDirect", function()
  it("should direct-load-race_lap", function()
    local setup = race_lap_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-race_lap", setup.live and "live" or "unit")
...
function race_lap_direct_setup(mockres)
