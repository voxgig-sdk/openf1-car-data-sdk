...
describe("RaceLapEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set OPENF1_CAR_DATA_TEST_RACE_LAP_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    race_lap_ref01_data = helpers.to_map(type(race_lap_ref01_data_result) == 'table' and race_lap_ref01_data_result.data_get and race_lap_ref01_data_result:data_get() or race_lap_ref01_data_result)
...
function race_lap_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("OPENF1_CAR_DATA_TEST_RACE_LAP_ENTID")
