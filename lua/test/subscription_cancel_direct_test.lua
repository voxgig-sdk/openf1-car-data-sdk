-- SubscriptionCancel direct test
...
describe("SubscriptionCancelDirect", function()
  it("should direct-load-subscription_cancel", function()
    local setup = subscription_cancel_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-subscription_cancel", setup.live and "live" or "unit")
...
function subscription_cancel_direct_setup(mockres)
