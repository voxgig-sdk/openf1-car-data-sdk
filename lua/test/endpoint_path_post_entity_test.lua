...
describe("EndpointPathPostEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set OPENF_CARDATA_TEST_ENDPOINT_PATH_POST_ENTID JSON to run live")
      return
    end
...
function endpoint_path_post_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("OPENF_CARDATA_TEST_ENDPOINT_PATH_POST_ENTID")
