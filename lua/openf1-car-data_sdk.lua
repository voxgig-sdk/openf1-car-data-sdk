...
local Openf1CarDataSDK = {}
Openf1CarDataSDK.__index = Openf1CarDataSDK
...
Openf1CarDataSDK._make_feature = _make_feature


function Openf1CarDataSDK.new(options)
  local self = setmetatable({}, Openf1CarDataSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function Openf1CarDataSDK:options_map()
...
function Openf1CarDataSDK:get_utility()
  return Utility.copy(self._utility)
end


function Openf1CarDataSDK:get_root_ctx()
  return self._rootctx
end


function Openf1CarDataSDK:prepare(fetchargs)
...
function Openf1CarDataSDK:direct(fetchargs)
...
-- by passing it.
function Openf1CarDataSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function Openf1CarDataSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "Openf1CarDataSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function Openf1CarDataSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = Openf1CarDataSDK.new(sdkopts)
  sdk.mode = "test"
