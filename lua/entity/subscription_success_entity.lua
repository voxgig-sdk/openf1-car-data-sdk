...
local SubscriptionSuccessEntity = {}
SubscriptionSuccessEntity.__index = SubscriptionSuccessEntity


function SubscriptionSuccessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionSuccessEntity)
  self._name = "subscription_success"
  self._client = client
...
function SubscriptionSuccessEntity:get_name()
  return self._name
end


function SubscriptionSuccessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionSuccessEntity.new(self._client, opts)
end
...
function SubscriptionSuccessEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionSuccessEntity:deleted()
  return true == self._deleted
end


function SubscriptionSuccessEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionSuccessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionSuccessEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionSuccessEntity:match_get()
...
function SubscriptionSuccessEntity:stream(action, args, callopts)
...
function SubscriptionSuccessEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionSuccessEntity
