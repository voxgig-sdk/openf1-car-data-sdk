...
local CreateCheckoutSessionEntity = {}
CreateCheckoutSessionEntity.__index = CreateCheckoutSessionEntity


function CreateCheckoutSessionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateCheckoutSessionEntity)
  self._name = "create_checkout_session"
  self._client = client
...
function CreateCheckoutSessionEntity:get_name()
  return self._name
end


function CreateCheckoutSessionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateCheckoutSessionEntity.new(self._client, opts)
end
...
function CreateCheckoutSessionEntity:mark_deleted()
  self._deleted = true
end


function CreateCheckoutSessionEntity:deleted()
  return true == self._deleted
end


function CreateCheckoutSessionEntity:data_set(args)
  if args ~= nil then
...
function CreateCheckoutSessionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateCheckoutSessionEntity:match_set(args)
  if args ~= nil then
...
function CreateCheckoutSessionEntity:match_get()
...
function CreateCheckoutSessionEntity:stream(action, args, callopts)
...
function CreateCheckoutSessionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateCheckoutSessionEntity
