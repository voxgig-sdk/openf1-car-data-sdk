-- Openf1CarData SDK SubscriptionCancel entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionCancelEntity = {}
SubscriptionCancelEntity.__index = SubscriptionCancelEntity


function SubscriptionCancelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionCancelEntity)
  self._name = "subscription_cancel"
  self._client = client
...
function SubscriptionCancelEntity:get_name()
  return self._name
end


function SubscriptionCancelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionCancelEntity.new(self._client, opts)
end
...
function SubscriptionCancelEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionCancelEntity:deleted()
  return true == self._deleted
end


function SubscriptionCancelEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionCancelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionCancelEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionCancelEntity:match_get()
...
function SubscriptionCancelEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionCancelLoadMatch
---@param ctrl? table
---@return SubscriptionCancel
---@return string? err
function SubscriptionCancelEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SubscriptionCancelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionCancelEntity
