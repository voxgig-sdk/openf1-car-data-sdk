...
func (sdk *Openf1CarDataSDK) OptionsMap() map[string]any {
...
func (sdk *Openf1CarDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *Openf1CarDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *Openf1CarDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Openf1CarDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *Openf1CarDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *Openf1CarDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("Openf1CarDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *Openf1CarDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Openf1CarDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("Openf1CarDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *Openf1CarDataSDK {
	...
	sdk := NewOpenf1CarDataSDK(sdkopts)
	sdk.Mode = "test"
