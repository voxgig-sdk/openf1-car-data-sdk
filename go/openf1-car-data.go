...
// instead of `sdk.NewOpenf1CarDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *Openf1CarDataSDK  { return NewOpenf1CarDataSDK(nil) }
func Test() *Openf1CarDataSDK { return TestSDK(nil, nil) }
