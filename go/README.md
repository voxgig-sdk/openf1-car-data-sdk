...
The Golang SDK for the Openf1CarData API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/openf1-car-data-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/openf1-car-data-sdk=../path/to/github.com/voxgig-sdk/openf1-car-data-sdk
```
...
```go
// Create
created, _ := client.CreateCheckoutSession(nil).Create(
...
| `EndpointPathPost` | `(data map[string]any) Openf1CarDataEntity` | Create a EndpointPathPost entity instance. |
...
```
github.com/voxgig-sdk/openf1-car-data-sdk/
...
The root package (`github.com/voxgig-sdk/openf1-car-data-sdk`) re-exports everything needed
