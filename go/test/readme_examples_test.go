...
const testSeed = `map[string]any{"entity": map[string]any{"create_checkout_session": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "endpoint_path_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "race_lap": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription_cancel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription_success": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
