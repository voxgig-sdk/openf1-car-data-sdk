...
func TestWebhookEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set OPENF_CARDATA_TEST_WEBHOOK_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func webhookBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("OPENF_CARDATA_TEST_WEBHOOK_ENTID")
