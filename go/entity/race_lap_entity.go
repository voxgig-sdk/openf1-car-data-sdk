...
func NewRaceLapEntity(client *core.Openf1CarDataSDK, entopts map[string]any) *RaceLapEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RaceLapEntity) GetName() string { return e.name }
...
func (e *RaceLapEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RaceLapEntity) Deleted() bool {
	return e.deleted
}


func (e *RaceLapEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRaceLapEntity(e.client, opts)
}

func (e *RaceLapEntity) Data(args ...any) any {
...
func (e *RaceLapEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RaceLap; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RaceLapEntity) DataTyped(data ...RaceLap) RaceLap {
	if len(data) > 0 {
		return typedFrom[RaceLap](e.Data(asMap(data[0])))
	}
	return typedFrom[RaceLap](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RaceLap (all fields
// optional at the wire level).
func (e *RaceLapEntity) MatchTyped(match ...RaceLap) RaceLap {
	if len(match) > 0 {
		return typedFrom[RaceLap](e.Match(asMap(match[0])))
	}
	return typedFrom[RaceLap](e.Match())
}
...
func (e *RaceLapEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RaceLapEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RaceLapLoadMatch and returns an RaceLap. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RaceLapEntity) LoadTyped(reqmatch RaceLapLoadMatch, ctrl map[string]any) (RaceLap, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RaceLap{}, err
	}
	return typedFrom[RaceLap](res), nil
}



func (e *RaceLapEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RaceLapEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// RaceLapCreateData and returns an RaceLap. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RaceLapEntity) CreateTyped(reqdata RaceLapCreateData, ctrl map[string]any) (RaceLap, error) {
...
func (e *RaceLapEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RaceLapEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RaceLapEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
