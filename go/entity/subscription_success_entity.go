...
type SubscriptionSuccessEntity struct {
	name    string
...
func NewSubscriptionSuccessEntity(client *core.Openf1CarDataSDK, entopts map[string]any) *SubscriptionSuccessEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubscriptionSuccessEntity) GetName() string { return e.name }
...
func (e *SubscriptionSuccessEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubscriptionSuccessEntity) Deleted() bool {
	return e.deleted
}


func (e *SubscriptionSuccessEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubscriptionSuccessEntity(e.client, opts)
}

func (e *SubscriptionSuccessEntity) Data(args ...any) any {
...
func (e *SubscriptionSuccessEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *SubscriptionSuccessEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubscriptionSuccessEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SubscriptionSuccessEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubscriptionSuccessEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubscriptionSuccessEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubscriptionSuccessEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
