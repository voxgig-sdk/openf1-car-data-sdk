...
type EndpointPathPostEntity struct {
	name    string
...
func NewEndpointPathPostEntity(client *core.Openf1CarDataSDK, entopts map[string]any) *EndpointPathPostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EndpointPathPostEntity) GetName() string { return e.name }
...
func (e *EndpointPathPostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EndpointPathPostEntity) Deleted() bool {
	return e.deleted
}


func (e *EndpointPathPostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEndpointPathPostEntity(e.client, opts)
}

func (e *EndpointPathPostEntity) Data(args ...any) any {
...
func (e *EndpointPathPostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *EndpointPathPostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EndpointPathPostEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EndpointPathPostEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *EndpointPathPostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EndpointPathPostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EndpointPathPostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
