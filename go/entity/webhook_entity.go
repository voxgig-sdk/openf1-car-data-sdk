...
func NewWebhookEntity(client *core.Openf1CarDataSDK, entopts map[string]any) *WebhookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebhookEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
